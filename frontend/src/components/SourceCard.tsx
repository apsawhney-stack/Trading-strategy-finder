        ...
        <div className={`source-card ${scoreTier} ${isExpanded ? 'expanded' : ''}`}>
            ...
            <div className="card-header" onClick={handleToggle}>
                ...
                <div className="card-content">
                    ...
                    <span className="card-author">{authorLabel}: {source.author || 'Unknown'}</span>
                </div>
                ...
                <div className="quick-stats">
                    ...
                    {/* DTE Badge */}
                    {dteLabel && (
                        <span className="stat-badge dte">{dteLabel}</span>
                    )}
                    ...
                    {data?.management_rules?.profit_target?.value && (
                        <span className="stat-badge target">🎯 {
                            typeof data.management_rules.profit_target.value === 'string'
                                ? data.management_rules.profit_target.value.substring(0, 15) + (data.management_rules.profit_target.value.length > 15 ? '...' : '')
                                : data.management_rules.profit_target.value
                        }</span>
                    )}
